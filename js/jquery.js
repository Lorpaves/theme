...
function show(eventElement, targetElement, toggleElement) {
  $(eventElement).on("click", function () {
    $(targetElement).show(500, function () {
      $("#header").css("opacity", 0.6);
    });
  });
  $(toggleElement).on("click", function () {
    $(targetElement).hide(500, function () {
      $("#header").css("opacity", 1);
    });
  });
}
show("#header__btn", "div.sidebar", "#sidebar-btn");
// $("#header__btn").on("click", function () {
//   $("div.sidebar").show(500, function () {
//     $("#header").css("opacity", 0.6);
//   });
// });
// $("#sidebar-btn").on("click", function () {
//   $("div.sidebar").hide(500, function () {
//     $("#header").css("opacity", 1);
//   });
// });
// let isShow = false;
...
//   });
// });
function hideAndshow(eventElement, targetElement, opacityElement) {
  let isShow = false;
...
// hideAndshow("#header__btn", "div.sidebar");
hideAndshow("#search__btn", "#input", "#header");
// show("#search__btn", "#input", "#search__btn");
